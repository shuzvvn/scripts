...
for opt, arg in opts:
	if opt == "--in_file_1":
		try:
			...
			sys.exit('Cannot read in_file_1! No such file or directory.')
	elif opt == "--in_file_2":
		try:
			# read csv file as a list of lists
			with open(str(arg), 'r') as read_obj:
			...
			sys.exit('Cannot read in_file_2! No such file or directory.')
	elif opt == "--index_1":
		try:
			index_1 = int(arg)
		except ValueError:
			print("Oops! Not valid number for index_1. Proceed with index_1 = 0 ...")
	elif opt == "--index_2":
		try:
			index_2 = int(arg)
		except ValueError:
			print("Oops! Not valid number for index_2. Proceed with index_2 = 0 ...")
	elif opt == "--col_1":
		col_1 = str(arg)
	elif opt == "--col_2":
		col_2 = str(arg)
...
def list2dict_index(in_list, ID, in_index, col):
	out_dict = {}
...
# count lines match/merge in output file
count_merge = 0
...
# print verbose
if verbose:
	print('count_in_1 = %i, count_in_2 = %i, count_merge = %i' % (count_in_1, count_in_2, count_merge))