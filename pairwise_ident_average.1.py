...
# Usage:
# python3 /home/shu-ting/pyscript/pairwise_ident_average.1.py --in_dir=/home/shu-ting/project/ecoli01/ecoli01.35/aa_alignment/ --out_file=/home/shu-ting/project/ecoli01/ecoli01.35/aa_alignment.ident
	...
	for file in os.listdir(in_dir):
		if file.endswith(in_ext):
			...
			for ID_pair in ID_pair_list: # get identity for each pair of seqs
				seq_pair = [str(record_dict[ID_pair[0]].seq), str(record_dict[ID_pair[1]].seq)]
