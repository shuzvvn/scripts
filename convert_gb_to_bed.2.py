...
# v2 2019/11/04
# add exception for features without locus_tag
# v1 2018/02/25
...
# Usage: python3 /home/shutingcho/pyscript/convert_gb_to_bed.2.py --in_file=/home/shutingcho/project/phyto30/phyto30.12/tbl2asn/v2.gb --out_file=/home/shutingcho/project/phyto29/phyto29.03/v2.bed
		...
		if feature.type != 'source':
			...
			try:
				...
				try:
					...
					# some features does not have a locus tag
					name = "NA"
			if feature.strand < 0:
				strand = "-"
			else:
